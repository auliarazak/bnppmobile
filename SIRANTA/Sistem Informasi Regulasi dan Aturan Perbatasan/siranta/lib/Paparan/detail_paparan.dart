...
class DetailPaparan extends StatefulWidget {
  final int paparanId;
  const DetailPaparan({super.key, required this.paparanId});

  @override
  State<DetailPaparan> createState() => _DetailPaparanState();
}

class _DetailPaparanState extends State<DetailPaparan> {
  late Future<Map<String, dynamic>> _paparanData;
  bool _isLoading = true;
  String? _error;

  Future<Map<String, dynamic>> fetchPaparanDetail(int id) async {
    try {
      final url = '${ApiConfig.baseUrl}detail-paparan/$id';
      ...
      throw Exception(
          'Gagal untuk menampilkan detail paparan: ${e.toString()}');
    }
  }

  Future<void> _loadPaparanDetail() async {
    try {
      setState(() {
        _isLoading = true;
        _error = null;
      ...
      _paparanData = fetchPaparanDetail(widget.paparanId);
      await _paparanData;
      ...
      setState(() {
        _isLoading = false;
        _error = 'Gagal untuk menampilkan detail paparan: ${e.toString()}';
      });
    }
  }
