...
class DetailPeraturanMou extends StatefulWidget {
  final int peraturanId;
  const DetailPeraturanMou({super.key, required this.peraturanId});

  @override
  // ignore: library_private_types_in_public_api
  _DetailPeraturanMouState createState() => _DetailPeraturanMouState();
}

class _DetailPeraturanMouState extends State<DetailPeraturanMou> {
  ...
  Future<Map<String, dynamic>> fetchPeraturanDetail(int id) async {
    try {
      final response = await http
          .get(
        Uri.parse('${ApiConfig.baseUrl}peraturan-mou/$id'),
      )
          .timeout(
