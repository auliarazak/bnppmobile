...
import 'package:siranta/Peraturans/MoU/detail_peraturan_mou.dart';
import 'package:siranta/apicon.dart';

class ListPeraturanMou extends StatefulWidget {
  const ListPeraturanMou({super.key});

  @override
  State<ListPeraturanMou> createState() => _ListPeraturanMouState();
}

class _ListPeraturanMouState extends State<ListPeraturanMou> {
  ...
  Future<void> fetchPeraturan() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          '${ApiConfig.baseUrl}peraturan-mou'));
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            DetailPeraturanMou(peraturanId: peraturanId),
                      ),
                    );
                  },
