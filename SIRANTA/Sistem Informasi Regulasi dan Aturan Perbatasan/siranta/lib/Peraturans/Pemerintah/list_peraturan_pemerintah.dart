...
import 'package:siranta/Peraturans/Pemerintah/detail_peraturan_pemerintah.dart';
import 'package:siranta/apicon.dart';

class ListPeraturanPemerintah extends StatefulWidget {
  const ListPeraturanPemerintah({super.key});

  @override
  State<ListPeraturanPemerintah> createState() => _ListPeraturanPemerintahState();
}

class _ListPeraturanPemerintahState extends State<ListPeraturanPemerintah> {
  ...
  Future<void> fetchPeraturan() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          '${ApiConfig.baseUrl}peraturan-pemerintah'));
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            DetailPeraturanPemerintah(peraturanId: peraturanId),
                      ),
                    );
                  },
