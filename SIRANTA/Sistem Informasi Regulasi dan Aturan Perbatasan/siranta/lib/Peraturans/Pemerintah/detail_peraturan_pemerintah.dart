...
class DetailPeraturanPemerintah extends StatefulWidget {
  final int peraturanId;
  const DetailPeraturanPemerintah({super.key, required this.peraturanId});

  @override
  // ignore: library_private_types_in_public_api
  _DetailPeraturanPemerintahState createState() => _DetailPeraturanPemerintahState();
}

class _DetailPeraturanPemerintahState extends State<DetailPeraturanPemerintah> {
  ...
  Future<Map<String, dynamic>> fetchPeraturanDetail(int id) async {
    try {
      final response = await http
          .get(
        Uri.parse('${ApiConfig.baseUrl}peraturan-pemerintah/$id'),
      )
          .timeout(
