...
class DetailPeraturanBnpp extends StatefulWidget {
  final int peraturanId;
  const DetailPeraturanBnpp({super.key, required this.peraturanId});

  @override
  // ignore: library_private_types_in_public_api
  _DetailPeraturanBnppState createState() => _DetailPeraturanBnppState();
}

class _DetailPeraturanBnppState extends State<DetailPeraturanBnpp> {
  ...
  Future<Map<String, dynamic>> fetchPeraturanDetail(int id) async {
    try {
      final response = await http
          .get(
        Uri.parse('${ApiConfig.baseUrl}peraturan-bnpp/$id'),
      )
          .timeout(
