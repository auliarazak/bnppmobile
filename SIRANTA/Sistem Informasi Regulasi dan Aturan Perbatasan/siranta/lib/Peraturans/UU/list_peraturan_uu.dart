...
import 'package:siranta/Peraturans/UU/detail_peraturan_uu.dart';
import 'package:siranta/apicon.dart';

class ListPeraturanUU extends StatefulWidget {
  const ListPeraturanUU({super.key});

  @override
  State<ListPeraturanUU> createState() => _ListPeraturanUUState();
}

class _ListPeraturanUUState extends State<ListPeraturanUU> {
  ...
  Future<void> fetchPeraturan() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          '${ApiConfig.baseUrl}peraturan-uu'));
