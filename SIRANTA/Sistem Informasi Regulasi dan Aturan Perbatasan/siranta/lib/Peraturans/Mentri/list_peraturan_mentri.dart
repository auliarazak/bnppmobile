...
import 'package:siranta/Peraturans/Mentri/detail_peraturan_mentri.dart';
import 'package:siranta/apicon.dart';

class ListPeraturanMentri extends StatefulWidget {
  const ListPeraturanMentri({super.key});

  @override
  State<ListPeraturanMentri> createState() => _ListPeraturanMentriState();
}

class _ListPeraturanMentriState extends State<ListPeraturanMentri> {
  ...
  Future<void> fetchPeraturan() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          '${ApiConfig.baseUrl}peraturan-mentri'));
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            DetailPeraturanMentri(peraturanId: peraturanId),
                      ),
                    );
                  },
