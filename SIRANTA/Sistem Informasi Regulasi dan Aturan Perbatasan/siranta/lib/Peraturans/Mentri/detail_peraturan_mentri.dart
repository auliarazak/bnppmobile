...
class DetailPeraturanMentri extends StatefulWidget {
  final int peraturanId;
  const DetailPeraturanMentri({super.key, required this.peraturanId});

  @override
  // ignore: library_private_types_in_public_api
  _DetailPeraturanMentriState createState() => _DetailPeraturanMentriState();
}

class _DetailPeraturanMentriState extends State<DetailPeraturanMentri> {
  ...
  Future<Map<String, dynamic>> fetchPeraturanDetail(int id) async {
    try {
      final response = await http
          .get(
        Uri.parse('${ApiConfig.baseUrl}peraturan-mentri/$id'),
      )
          .timeout(
