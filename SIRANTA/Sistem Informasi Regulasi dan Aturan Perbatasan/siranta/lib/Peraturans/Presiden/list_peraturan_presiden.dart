...
import 'package:siranta/Peraturans/Presiden/detail_peraturan_presiden.dart';
import 'package:siranta/apicon.dart';

class ListPeraturanPresiden extends StatefulWidget {
  const ListPeraturanPresiden({super.key});

  @override
  State<ListPeraturanPresiden> createState() => _ListPeraturanPresidenState();
}

class _ListPeraturanPresidenState extends State<ListPeraturanPresiden> {
  ...
  Future<void> fetchPeraturan() async {
    ...
    try {
      final response = await http.get(Uri.parse(
          '${ApiConfig.baseUrl}peraturan-presiden'));
                ...
                ElevatedButton.icon(
                  onPressed: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            DetailPeraturanPresiden(peraturanId: peraturanId),
                      ),
                    );
                  },
