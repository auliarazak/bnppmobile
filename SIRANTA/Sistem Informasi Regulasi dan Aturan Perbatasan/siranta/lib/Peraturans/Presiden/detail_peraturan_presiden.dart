...
class DetailPeraturanPresiden extends StatefulWidget {
  final int peraturanId;
  const DetailPeraturanPresiden({super.key, required this.peraturanId});

  @override
  // ignore: library_private_types_in_public_api
  _DetailPeraturanPresidenState createState() => _DetailPeraturanPresidenState();
}

class _DetailPeraturanPresidenState extends State<DetailPeraturanPresiden> {
  ...
  Future<Map<String, dynamic>> fetchPeraturanDetail(int id) async {
    try {
      final response = await http
          .get(
        Uri.parse('${ApiConfig.baseUrl}peraturan-presiden/$id'),
      )
          .timeout(
