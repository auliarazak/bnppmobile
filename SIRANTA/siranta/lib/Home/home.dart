...
import 'package:siranta/Layanan/layanan.dart';
...
class _HomeState extends State<Home> {
  ...
  child: GridView.count(
    ...
    children: [
      _buildGridButton('UU', 'assets/icons/PeraturanPalu.png', () {
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => ListPeraturan()), // Navigate to ListPeraturan
        );
      }),
      _buildGridButton('Peraturan\nPemerintah', 'assets/icons/PeraturanBoard.png', () {
  ...
  Widget _buildGridButton(String label, String imagePath, VoidCallback onPressed) {
  return Column(
    ...
    children: [
      ...
      Text(
        ...
        style: TextStyle(fontSize: 14, fontFamily: 'PlusJakartaSans', fontWeight: FontWeight.w500),
      ),
    ],
  );
}
