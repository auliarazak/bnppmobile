            ...
            switch (index) {
              case 0:
                return _buildServiceButton(
                  imagePath: 'lib/images/PeraturanMentri.png',
                  label: 'Layanan 1',
                  onTap: () {
              ...
              case 1:
                return _buildServiceButton(
                  imagePath: 'lib/images/Peraturan.png',
                  label: 'Layanan 2',
                  onTap: () {
              ...
              case 2:
                return _buildServiceButton(
                  imagePath: 'lib/images/Peraturan2.png',
                  label: 'Layanan 3',
                  onTap: () {
              ...
              case 3:
                return _buildServiceButton(
                  imagePath: 'lib/images/Peraturan3.png',
                  label: 'Layanan 4',
                  onTap: () {
                ...
                case 4:
                return _buildServiceButton(
                  imagePath: 'lib/images/Peraturan4.png',
                  label: 'Layanan 4',
                  onTap: () {
                    // Aksi ketika tombol Layanan 4 ditekan
                  },
                ...
                case 5:
                return _buildServiceButton(
                  imagePath: 'lib/images/Peraturan5.png',
                  label: 'Layanan 4',
                  onTap: () {
                    // Aksi ketika tombol Layanan 4 ditekan
                  },
                ...
                case 6:
                return _buildServiceButton(
                  imagePath: 'lib/images/PeraturanBNPP.png',
                  label: 'Layanan 4',
                  onTap: () {
                    // Aksi ketika tombol Layanan 4 ditekan
                  },
